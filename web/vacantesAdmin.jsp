    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <jsp:include page="partials/tituloContent.jsp"> 
                <jsp:param name="titulo" value="Lista de Vacantes" /> 
            </jsp:include> 
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between form-group">
                                        <a href="frmvacante.jsp" class="btn btn-success btn-sm border"><i class="fas fa-plus"></i> Nuevo</a>

                                        <form action="vacantesAdmin" method="get" class=" w-50">
                                               ...
                                               <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group " role="group" aria-label="button-actions">
                                                            <a href="vacantesAdmin?action=editar&id=${vacante.id}" class="btn btn-secondary btn-sm"><i class="fas fa-edit"></i> Editar</a>
                                                            <a href="vacantesAdmin?action=eliminar&id=${vacante.id}"class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> Eliminar</a>
